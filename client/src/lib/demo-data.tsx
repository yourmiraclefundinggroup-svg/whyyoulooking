...
export const DEMO_PROFILE: ScoreShiftProfile = {
  ...
  disputes: [
    {
      id: 1, issueId: 10, bureau: "Experian", status: "in_progress",
      dateSent: "2025-04-02", dateDelivered: "2025-04-06", expectedResponse: "2025-05-06",
      letterContent: null, trackingNumber: "9214890100000000000001",
      creditor: "MIDLAND FUNDING LLC", issueType: "collection", issueTitle: "Collection Account", outcome: null,
    },
    {
      id: 2, issueId: 11, bureau: "Equifax", status: "in_progress",
      dateSent: "2025-04-10", dateDelivered: "2025-04-14", expectedResponse: "2025-05-14",
      letterContent: null, trackingNumber: "9214890100000000000002",
      creditor: "CITI BANK", issueType: "late_payment", issueTitle: "Late Payment — 30 days", outcome: null,
    },
    {
      id: 3, issueId: 12, bureau: "TransUnion", status: "completed",
      dateSent: "2025-03-01", dateDelivered: "2025-03-05", expectedResponse: "2025-04-05",
      letterContent: null, trackingNumber: "9214890100000000000003",
      creditor: "CITI BANK", issueType: "collection", issueTitle: "Collection Account", outcome: "removed",
    },
    {
      id: 4, issueId: 13, bureau: "Experian", status: "completed",
      dateSent: "2025-02-20", dateDelivered: "2025-02-24", expectedResponse: "2025-03-24",
      letterContent: null, trackingNumber: "9214890100000000000004",
      creditor: "PORTFOLIO RECOVERY", issueType: "collection", issueTitle: "Collection Account", outcome: "removed",
    },
  ],
  violations: [
  ...
  meta: { source: "pdf_upload", fetchedAt: new Date().toISOString(), reportDate: "2025-04-01", isLive: false },
};
