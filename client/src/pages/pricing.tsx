...
const businessPlans = [
  {
    ...
    popular: false,
    badge: null,
    crcComparison: "CRC charges $179/mo for this tier",
    features: [
      "Up to 5 clients",
      "Full client portal",
      "AI dispute letter generation",
  ...
  },
  {
    ...
    popular: true,
    badge: "Most Popular — Half the price of CRC",
    crcComparison: "CRC Start plan is $179/mo",
    features: [
      "Up to 50 clients",
      "Full Dispute IQ™ AI letters",
      "AutoCycle automation",
      "Lob.com certified mail",
      "Team management (2 users)",
      "Loan readiness module",
  ...
  },
  {
    ...
    price: 199,
    yearlyPrice: 166,
    description: "Scale to 200 clients with full automation",
    popular: false,
    badge: null,
    crcComparison: "CRC Grow plan is $299/mo",
    features: [
      "Up to 200 clients",
      "Everything in Pro",
      "5 team members",
      "Affiliate portal",
      "Voice AI client qualifier",
      "DSCR loan referral pipeline",
      "API access",
      "Custom branding",
    ],
  },
  {
    ...
    price: 349,
    yearlyPrice: 291,
    description: "1,000 clients. Full power. Dedicated support.",
    popular: false,
    badge: null,
    crcComparison: "CRC Scale plan is $399/mo",
    features: [
      "Up to 1,000 clients",
      "Everything in Scale",
      "15 team members",
      "Dedicated account manager",
      "DSCR referral revenue sharing",
      "Priority builds",
      "SLA guarantee",
    ],
  },
