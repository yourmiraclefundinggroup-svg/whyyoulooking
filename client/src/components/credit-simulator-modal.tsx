      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="font-medium text-gray-900">Select actions you're considering:</h3>
            {actions.map((action) => (
            ...
            <div className="border-t pt-6 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <div className="text-2xl font-bold text-gray-900">{simulationResult.currentScore}</div>
              ...
              <div className="space-y-2">
                <h4 className="font-medium text-gray-900">Breakdown by Action:</h4>
